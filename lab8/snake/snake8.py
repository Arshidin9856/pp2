...
import random
import time 
# Checking for border (wall) collision and whether the snake is leaving the playing area  done 
# Generate random position for food, so that it does not fall on a wall or a snake done for 1 food 
# Add levels. For example, when the snake receives 3-4 foods or depending on score  done 
# Increase speed when the user passes to the next level done
# Add counter to score and level done
pygame.init()
